...
-- Dumping database structure for food-market-backend
CREATE DATABASE IF NOT EXISTS `food-market-backend` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `food-market-backend`;
